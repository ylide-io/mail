export enum RoutePath {
	...
	FEED_VENOM_PROJECT = '/feed/venom/:projectId',
	FEED_VENOM_ADMIN = '/feed/venom/:projectId/admin',
	FEED_TVM = '/feed/tvm',
	FEED_TVM_PROJECT = '/feed/tvm/:projectId',
	FEED_TVM_ADMIN = '/feed/tvm/:projectId/admin',
