...
const EthereumLogo = () => {
    return (
    <svg xmlns="http://www.w3.org/2000/svg" width="30px" height="30px" version="1.1" shapeRendering="geometricPrecision" textRendering="geometricPrecision" imageRendering="optimizeQuality" fillRule="evenodd" clipRule="evenodd"
