...
const walletsMap: Record<
    string,
    { title: string; link: string; logo: JSX.Element }
> = {
    metamask: {
        title: "MetaMask",
    ...
    let content = (
        <div className="wallets-block">
            {topWallets.map(({ blockchains, wallet }) => {
                ...
                const isWalletSupported = domain.availableSenders.find(
                    (t) => t.wallet === wallet
                );
                const isWalletAvailable = domain.availableWallets.find(
                    (t) => t.wallet === wallet
                );
                const isWalletConnected = domain.connectedWallets.find(
                    (t) => t.wallet === wallet
                );
                ...
                return (
                    ...
                    >
                                    ...
                                    <YlideButton
                                        onClick={async () => {
                                            if (!isWalletAvailable) {
                                                ...
                                                const password =
                                                    await domain.handlePasswordRequest(
                                                        `connect ${wData.title}`
                                                    );
                                                if (!password) {
                                                    return;
                                                ...
                                                if (!firstTime) {
                                                    const registeredPublicKey =
                                                        await reader.extractPublicKeyFromAddress(
                                                            me.address
                                                        );
                                                    if (!registeredPublicKey) {
                                                        ...
                                                        if (
                                                            registeredPublicKey.length !==
                                                                tempKey
                                                                    .publicKey
                                                                    .length ||
                                                            !registeredPublicKey.every(
                                                                (v, idx) =>
                                                                    v ===
                                                                    tempKey
                                                                        .publicKey[
                                                            ...
                                                            domain.keystore.keys.splice(
                                                                domain.keystore.keys.findIndex(
                                                                    (g) =>
                                                                        g.key ===
                                                                        tempKey
                                                                ),
                                ...
                                {blockchains.map((blockchain) => {
                                    ...
                                    return (
                                        <div
                                            className="wb-chain"
                                            style={{
                                                opacity: isChainSupported
                                                    ? 1
                                                    : 0.6,
                                            }}
                                        >
                                            <div className="wb-chain-logo">
                                                {bData.logo}
                                            </div>
                                            <div className="wb-chain-title">
                                                {bData.title}
                                            </div>
                                        </div>
                                    );
                        ...
                        {!isWalletSupported ? (
                            <div className="wb-not-available">
                        ...
                        {helperModal === "sign" ? (
                            <>
                                ...
                                <h3 style={{ fontSize: 22, fontWeight: "400" }}>
                                    We need you to sign your password so we can
                                    generate you
                                    <br />
                                    <div
                                        style={{
                            ...
                            <>
                                ...
                                <h3 style={{ fontSize: 22, fontWeight: "400" }}>
                                    To receive messages from other people we
                                    need you to
                                    <br />
                                    <div
                                        style={{
            ...
            <div style={{ width: 300 }}>
                ...
                {domain.areThereAnyConnectedKeys ? (
                    <div style={{ marginTop: 20 }}>
                        ...
                        >
                            Continue with connected wallets{" "}
