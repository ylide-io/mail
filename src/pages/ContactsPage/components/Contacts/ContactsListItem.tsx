...
const ContactsListItem: React.FC<ContactsListItemProps> = ({
    ...
    const [tags, setTags] = useState<ITag[]>(
        TagsStore.getTagsFromIds(contact.tags)
    );
    ...
    const checkNewContactErrors = (newContact: IContact) => {
        ...
        const duplicateContact = contacts.contacts.find(
            (elem) => elem.address === newContact.address
        );
    ...
    const mailThisContact = () => {
        mailbox.recipients = [contact.address];
        navigate("/compose");
    };
